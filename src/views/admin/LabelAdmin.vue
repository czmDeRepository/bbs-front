<template>
    <div class="labelContent">
        <el-row>
            <el-col :span="6">
                <el-input v-model="name" size="medium" placeholder="请输入标签名" class="input-with-select">
            ...
            :default-sort = "{prop: 'updateTime', order: 'ascending'}">
                ...
                <el-table-column label="操作">
                    <template slot-scope="scope">
                        <el-button type="warning" plain @click="modify(scope.$index)" size="small">修改</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <div class="block">
