			...
			<div class="content">
				...
				<div  class="comment-f">
					<div>
						...
						<i class="iconfont" :class="item.commentUser.gender == '男' ? 'icon-man' : 'icon-woman'"></i>
				...
				<div class="reply-content reply-fa">
							<div class="reply-font" @click="doReply(item.id)">
								<div>
									<img :src="require('@/static/img/icon/reply.png')" class="icon-reply"><font class="icon-reply icon-hf">回复</font>
								</div>
				...
				<div class="content">
						...
						<div  class="comment-f">
							<div>
								...
								<i class="iconfont" :class="ritem.commentUser.gender == '男' ? 'icon-man' : 'icon-woman'"></i>
